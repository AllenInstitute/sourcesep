...
Note that $\lexc$ refers to the excitation wavelength. 
...
3. Emission spectrum of the bound and free states $S_\textrm{b}(\lambda)$ and $S_\textrm{f}(\lambda)$. Both are normalized such that the integral over $\lambda$ is 1.
