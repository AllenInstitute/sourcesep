...
def set_norm(M, axis=0, c=1.0):
    ...
    Args:
        ...
        axis (int, optional): axis along which to normalize. Defaults to 0.
        c (float, optional): Set norm to a fixed value. Defaults to 1.0.

    Returns:
        np.array: normalized array
        np.float: (norm before normalization) / c
    """
